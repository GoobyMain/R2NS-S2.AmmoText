...
void function reloadingTextSettings(){
    #if UI
    ModSettings_AddModTitle("S2.AmmoText")
    ModSettings_AddModCategory("Main")
    ModSettings_AddSetting("s2_reload_main_pos", "Position", "vector")
    ModSettings_AddSetting("s2_reload_main_size", "Font Size", "float")
    ModSettings_AddEnumSetting("s2_reload_main_pilots", "Pilot Weapons", ["Off", "On"])
    ModSettings_AddEnumSetting("s2_reload_main_titans", "Titan Weapons", ["Off", "On"])
    ModSettings_AddEnumSetting("s2_reload_ads_fade", "ADS Fade Toggle", ["Off", "On"])
    ModSettings_AddSetting("s2_reload_ads_fade_opa", "ASD Alpha", "float")

    ModSettings_AddModCategory("Low Ammo")
    ModSettings_AddSetting("s2_reload_low_text", "Text", "string")
    ModSettings_AddSetting("s2_reload_low_reserve_text", "No Extra Ammo Text", "string")
    ModSettings_AddSetting("s2_reload_low_alpha", "Alpha", "float")
    ModSettings_AddSetting("s2_reload_min_ammo", "Magazine %", "Int")
    ModSettings_AddSetting("s2_reload_low_static_col", "Static Colour", "vector")
    ModSettings_AddEnumSetting("s2_reload_low_is_static", "Static Colour Toggle", ["Off", "On"])
    ModSettings_AddSetting("s2_reload_low_first_col", "First Colour", "vector")
    ModSettings_AddSetting("s2_reload_low_second_col", "Second Colour", "vector")
    ModSettings_AddSetting("s2_reload_flash_min_ammo", "Flash Magazine %", "Int")
    ModSettings_AddEnumSetting("s2_reload_low_flash", "Flash Toggle", ["Off", "On"])
    ModSettings_AddEnumSetting("s2_reload_low_rgb", "RGB Cycle Toggle", ["Off", "On :D"])

    ModSettings_AddModCategory("Reloading")
    ModSettings_AddSetting("s2_reload_none_text", "Text","string")
    ModSettings_AddSetting("s2_reload_none_alpha", "Alpha","float")
    ModSettings_AddSetting("s2_reload_none_col", "Colour","vector")
    ModSettings_AddEnumSetting("s2_reload_none_flash", "Flash Toggle", ["Off", "On"])
    ModSettings_AddEnumSetting("s2_reload_none_rgb", "RGB Cycle Toggle",["Off", "On :D"])
    #endif
}
